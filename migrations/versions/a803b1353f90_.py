...
Revision ID: a803b1353f90
Revises: 
Create Date: 2022-08-08 11:28:50.896492
...
def upgrade():
    ...
    sa.Column('run', sa.String(length=200), nullable=False),
    ...
    sa.Column('sold_stock', sa.Integer(), nullable=False),
